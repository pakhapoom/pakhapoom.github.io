---
title: "PM#1: Foundations of Project Management"
date: 2023-11-28 6:15:00 +0700
...
* stakeholders: some people affected by the project's completion and success.

## Roles and responsibilities
* understand the cutomer's expectations.
    ...
    * what promptedd you to ask for help you now?
    * what is your hope for the outcome of this project?
* control changes: adjust stakeholder's needs.
* clarify goals: budget, deadeline, quality, requirements, other resources.
* manage the project.
...
* communicate status and concerns: building trust within the team and among stakeholders.
* build a great team.
...
* break down barriers: ensure that issues and risks are tracked and visible and establish escalation paths.
* measure progress: how team members have completed tasks, ask if any help is needed.
...
> The float is the amount of time you can wait to begin a task before it impacts the project schdule and treatens the project outcome.
{: .prompt-info}

## Project life cycle
* initiate the project: define project goals, identify budget, whom will be involved, and value.
    * who are the stakeholders?
    * what are the client's or customer's goals?
    * what is the purpose and mission of the project?
    * what are teh measurable objectives for the team?
    * what is the project trying to improve?
    * what does this project need to be completed?
    * what skills and resources will the project require?
    * what will the project cost? what are the benefits?
* make a plan: create a budget, set the schedule, establish a team, determine role and responsibility, plan for risks and challenges, establish communication.
...
* execute and complete tasks: manage the progress, communicate, make adjustments.
    ...
    * adapt to changs in the project as they arise.
* close the project: evaluate how the project went and reflect.
    * ensure that all talks have been completed, confirm acceptance of the project outcome, reflect on lessons learned, retrospective, communicate the results with stakesholders, celebrate completion of the project, formally move on to a new project.
    ...
    * maintain deliverables and get stakeholder apoproval.
...
### DMAIC
* define: define the project goal aand talk to stakeholders about expectations for the project.
...
### LEAN
* a methodology originated in the manufacturing world - waste removal within an operation, e.g., defects, excess processing, over prodution.
* 5s
    * sort: remove all items not needed for current production operations and leave only bare essentials.
    * set in order: arrange needed items so that they are eascy to sue. Label items so that anyone can find them or put them away.
    * shine: keep everything in the correct place. Clean the workspace every day.
    * standardize: perform the process in teh sam way every time.
...
* can be inferred by the following questions.
    ...
    * what kind of pratices, behaviors and values are refelcted by the people in the organization?
