...
*Figure 1: Example of in-context learning. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*

However, even a seemingly miraculous phenomenon such as this deserves scientific investigation. In this article, we will delve into a study that analyzes what makes in-context learning work, by rethinking the role of demonstrations [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).
...
In their research paper [(Min et al., 2022)](https://arxiv.org/abs/2202.12837), the authors investigate the impact of various factors on in-context learning. Specifically, these factors are as follows:
...
*Figure 2: Components of in-context learning. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
...
*Figure 3: Model performance comparison between using no demonstrations, demonstrations with actual labels (gold labels), and demonstrations with random labels. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
...
*Figure 4: Model performance of different proportions of correct labels in the provided demonstrations. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
...
*Figure 5: Impact of the label space. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
...
*Figure 6: Impace of the input distribution. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
...
*Figure 9: Model performance when varying number of examples in the demonstrations. Reprinted from [(Min et al., 2022)](https://arxiv.org/abs/2202.12837).*
