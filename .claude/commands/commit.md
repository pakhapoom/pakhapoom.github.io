...
## Instructions
Stage all changes and create a git commit following the Conventional Commits format.
...
5. Run `git add <file1> <file2> <...>` — include modified, untracked, and `.claude/` files from `git status` — then `git commit -m "<your message>"`
