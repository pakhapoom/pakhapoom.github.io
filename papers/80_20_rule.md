...
[video](https://youtu.be/f5L_KT0WXKo)
...
![Figure 3](../assets/80_20_rule/fig03.png)(Figure: Temparature perturbations for high- and low-entropy tokens.)
...
![Table 2](../assets/80_20_rule/tab02.png)(Table: Main results comparing vanilla DAPO vs. forking-token DAPO on Qwen3-8B/14B/32B across AIME'24 and AIME'25, including Acc@16 and Len@16 metrics. Forking-token DAPO shows flat or negative results on 8B but increasingly large gains on 14B and 32B.)
